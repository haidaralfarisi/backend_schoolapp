    ...
    <div class="p-2">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                @php
                    $isActive =
                        Route::currentRouteName() == 'superadmin.schools.index' ||
                        in_array(Request::segment(2), ['kelas', 'student', 'lsplans']);
                @endphp
                <!-- Schools -->
                ...
                <!-- Users -->
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('superadmin.users.index') ? 'active' : '' }}"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('superadmin.parent.index') ? 'active' : '' }}"
                        href="{{ route('superadmin.parent.index') }}" aria-expanded="false">
